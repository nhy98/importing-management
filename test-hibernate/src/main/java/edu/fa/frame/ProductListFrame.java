...
public class ProductListFrame { 
	...
	{ 
		...
		lblHome.setIcon(new ImageIcon(ProductListFrame.class.getResource("/icon/home_48px_1.png")));
		...
		lblList.setIcon(new ImageIcon(ProductListFrame.class.getResource("/icon/list_64px.png")));
		//frame.getContentPane().add(sp); 
		JLabel lblSearchJLabel = new JLabel("Search by ID");
		lblSearchJLabel.setBounds(213,158,133,40);
		lblSearchJLabel.setIcon(new ImageIcon(ProductListFrame.class.getResource("/icon/search_20px_1.png")));

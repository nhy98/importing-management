...
public class SiteProductCreateFrame{
	private JTextField textId;
	private JTable table;
	
	public SiteProductCreateFrame() {
	}
	/**
	...
	public void createProductCreateUpdateFrame(JFrame frame) {
		...
		lblNewLabel.setIcon(new ImageIcon(SiteProductCreateFrame.class.getResource("/icon/home_48px_1.png")));
		...
		JLabel lblNewLabel_3 = new JLabel("Create Site Product");
		lblNewLabel_3.setForeground(new Color(51, 0, 255));
		lblNewLabel_3.setFont(new Font("Dialog", Font.BOLD, 16));
		lblNewLabel_3.setIcon(new ImageIcon(SiteProductCreateFrame.class.getResource("/icon/home_48px.png")));
		...
		textId.setBounds(631, 159, 123, 33);
		panel.add(textId);
		...
		lblNewLabel_4.setBounds(479, 159, 152, 28);
...
//		panel.add(table);
		...
		lblNewLabel_5.setBounds(63, 161, 114, 28);
		panel.add(lblNewLabel_5);
		
		final JComboBox<String> comboBox = new JComboBox<String>();
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Pen", "Book"}));
		comboBox.setFont(new Font("Verdana", Font.PLAIN, 16));
		comboBox.setBounds(189, 159, 256, 33);
		panel.add(comboBox);

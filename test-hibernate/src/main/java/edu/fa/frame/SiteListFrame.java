...
public class SiteListFrame { 
	// frame 
	JFrame f; 
	// Table 
	JTable j; 
	private JTextField textField;
	public SiteListFrame() {
	...
	{ 
		...
		// Column Names 
		String[] columnNames = { "Site name", "Address", "Mail", "Phone"}; 
		...
		lblHome.setIcon(new ImageIcon(SiteListFrame.class.getResource("/icon/home_48px_1.png")));
		...
		JLabel lblList = new JLabel("Site List");
		...
		lblList.setIcon(new ImageIcon(SiteListFrame.class.getResource("/icon/list_64px.png")));
		//frame.getContentPane().add(sp); 
		JLabel lblSearchJLabel = new JLabel("Search by ID");
		lblSearchJLabel.setBounds(213,158,133,40);
		lblSearchJLabel.setIcon(new ImageIcon(SiteListFrame.class.getResource("/icon/search_20px_1.png")));

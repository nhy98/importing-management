...
public class TransportationListFrame { 
	// frame 
	JFrame f; 
	// Table 
	JTable j; 
	private JTextField textField;
	public TransportationListFrame() {
	...
	{ 
		...
		// Column Names 
		String[] columnNames = { "Transportation name", "Days of delivery", "Other information"}; 
		...
		lblHome.setIcon(new ImageIcon(TransportationListFrame.class.getResource("/icon/home_48px_1.png")));
		...
		JLabel lblList = new JLabel("Transportation List");
		...
		lblList.setIcon(new ImageIcon(TransportationListFrame.class.getResource("/icon/list_64px.png")));
		//frame.getContentPane().add(sp); 
		JLabel lblSearchJLabel = new JLabel("Search by ID");
		lblSearchJLabel.setBounds(213,158,133,40);
		lblSearchJLabel.setIcon(new ImageIcon(TransportationListFrame.class.getResource("/icon/search_20px_1.png")));

...
public class SiteProductListFrame { 
	// frame 
	JFrame f; 
	// Table 
	JTable j; 
	private JTextField textField;
	public SiteProductListFrame() {
	...
	{ 
		...
		// Column Names 
		String[] columnNames = { "Product name", "Unit", "Quantity"}; 
		...
		lblHome.setIcon(new ImageIcon(SiteProductListFrame.class.getResource("/icon/home_48px_1.png")));
		...
		JLabel lblList = new JLabel("Site Product List");
		...
		lblList.setIcon(new ImageIcon(SiteProductListFrame.class.getResource("/icon/list_64px.png")));
		//frame.getContentPane().add(sp); 
		JLabel lblSearchJLabel = new JLabel("Search by ID");
		lblSearchJLabel.setBounds(213,158,133,40);
		lblSearchJLabel.setIcon(new ImageIcon(SiteProductListFrame.class.getResource("/icon/search_20px_1.png")));

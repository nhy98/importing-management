...
public class CreateFrame{
	 ...
	 */
	public void createImportFrame(JFrame frame) {
		String[][] data = { 
		...
		lblNewLabel.setIcon(new ImageIcon(HomeFrame.class.getResource("/main/images/home_48px_1.png")));
		...
		lblNewLabel_3.setIcon(new ImageIcon(CreateFrame.class.getResource("/main/images/list_64px.png")));
